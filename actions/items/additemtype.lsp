	...
	[0x0](LLL
		{
									...
									[0x0](LLL
										{
											...
											(when (= (calldataload 0) "init") 
												{
													...
													[[0x13]] (calldataload 96)
													[[0x14]] (calldataload 128)
													[[0x15]] (ORIGIN)
											...
											(when (= (calldataload 0) "execute")
												{													
													...
													[0xA0] @@0x14
													[0xC0] @@0x15
													(call (- (GAS) 100) @0x0 0 0x20 192 0x20 32)
			...
			; USAGE: 0 : "autoexecute", 32: "name", 64: "type", 96 : stacksize, <128 : address>
			; RETURNS: 1 if successful, 0 if not.
			...
			(when (= (calldataload 0) "autoexecute")
				{
					...
					[0x20] "registeritem"
					(calldatacopy 0x40 32 128) ; Calldata to 0x40
					[0xC0] (ORIGIN) 
					(call (- (GAS) 100) @0x0 0 0x20 192 0x20 32)
