									...
									[0x0](LLL
										{
											...
											(when (= (calldataload 0) "init") 
												{
													...
													(unless @0x0 (return 0x0 32) ) ; Stop if there is no action of this type.
													...
													[[0x11]] (calldataload 32) ; action name
													[[0x12]] (calldataload 64) ; new poll name
												}
											)
											...
											(when (= (calldataload 0) "execute")
												{													
													...
													[0x20] @@0x11
													[0x40] @@0x12
													(call (- (GAS) 100) @0x60 0 0x0 96 0x0 32) ; Change the poll type.
