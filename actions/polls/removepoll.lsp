									...
									[0x0](LLL
										{
											...
											(when (= (calldataload 0) "init") 
												{
													...
													(unless @0x0 (return 0x0 32) ) ; Must have an 'polltype' contract for this.
											...
											(when (= (calldataload 0) "execute")
												{													
													...
													[0x40] "dereg"
													[0x60] @@0x11
													(call (- (GAS) 100) @0x0 0 0x40 64 0x0 32) ; Dereg this polltype
			...
			(when (= (calldataload 0) "autoexecute")
				{
					...
					(call (- (GAS) 100) @0x0 0 0x40 64 0x0 32) ; Dereg.
